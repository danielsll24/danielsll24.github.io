...
G1<-waffle(
  ...
  colors = colores,
  title = "Votación en lo general, a favor",
  xlab="(329)", pad=0
)
iron(G1)
```
...
G2<-waffle(
  ...
  colors = colores,
  title="Votación en lo general, en contra",
  xlab="(153)", pad=15)
iron(G2)
```
...
G3<-waffle(
  ...
  colors=colores,
  title="Votación en lo general, abstenciones",
  xlab="(2)",pad=15
)
iron(G3)
```
...
G4<-waffle(
  ...
  colors=colores,
  title="Votación en lo general, ausencias",
  xlab="(16)",pad=5
)
iron(G4)
```
...
G5<-waffle(
  ...
  colors = colores,
  title = "Votación en lo particular, a favor",
  xlab="(326)", pad=0
)
iron(G5)
```
...
G6 <- waffle(
  ...
  colors=colores,
  title = "Votación en lo particular, en contra",
  xlab="(127)", pad=15
)
iron(G6)
```
...
G7 <- waffle(
  ...
  colors=colores,
  title = "Votación en lo particular, ausencias",
  xlab="(47)", pad=15
)
iron(G7)
```